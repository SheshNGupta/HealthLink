...
public class ManagerProcessRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public ManagerProcessRequestJPanel(JPanel jPanel, OrderWorkRequest fundRequest, Enterprise enterprise, UserAccount userAccount) {
        initComponents();
        this.jPanel = jPanel;
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        orderItemRequest.setSender(userAccount);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                browser.loadURL("https://www.google.com/maps/search/?api=1&query="+locationTxt.getText().trim());
            }
        });
        }
