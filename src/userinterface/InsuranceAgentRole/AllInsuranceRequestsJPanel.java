...
public class AllInsuranceRequestsJPanel extends javax.swing.JPanel {
    ...
    private InsAgentOrganization insuranceAgentOrganization;

    public AllInsuranceRequestsJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, InsAgentOrganization insuranceAgentOrganization) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnProcessRequest.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/yes.png"))); // NOI18N
    ...
    private void btnProcessRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessRequestActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            userProcessContainer.add("ProcessRequestJPanel", new InsuranceProcessRequestJPanel(userProcessContainer, userAccount, enterprise, insuranceWorkRequest));
