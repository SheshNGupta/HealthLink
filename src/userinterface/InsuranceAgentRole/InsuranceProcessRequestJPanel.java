 ...
 */
public class InsuranceProcessRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public InsuranceProcessRequestJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, InsuranceWorkRequest insuranceWorkRequest) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnAccept.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/send_queue.png"))); // NOI18N
        ...
        if (message.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                for (Organization organization : enterprise.getOrganizationDirectory().getOrganizations()) {
                    if (organization instanceof InsFinanceOrganization) {
                        org = organization;
                        break;
                    }
                }
