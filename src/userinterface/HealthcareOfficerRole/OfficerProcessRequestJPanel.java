...
public class OfficerProcessRequestJPanel extends javax.swing.JPanel {
    ...
    public OfficerProcessRequestJPanel(JPanel jPanel, UserAccount userAccount, GovernmentFundRequest fundRequest, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        sendRequestToSecretaryBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/userinterface/IconsImages/send_queue.png"))); // NOI18N
        ...
        if (message.equals("")) {
            ...
            try{
                SendEmail.send(governmentFundRequest.getAdminEmail(),"\nHi "+governmentFundRequest.getAdminName()+","+"\n\nYour funding request for Location "+ governmentFundRequest.getLocation()+
                        " is approved by Health Officer: "+userAccount.getEmployee().getName()
                +"\n\n\nThanks\nGovenrment",sub);
            }catch(Exception ex){
